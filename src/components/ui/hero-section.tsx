  ...
  return (
    <Carousel autoplay>
      ...
      <div>
        ...
        >
          ...
          >
            ...
            >
             Percel Delevary service Appointment Service Booking
            </h1>
            <p
              style={{
                marginTop: "30px",
      ...
      <div>
        ...
        >
          ...
          >
            ...
            >
              Ac Repair Service Appointment Service Booking
            </h1>
            <p
              style={{
                marginTop: "30px",
      ...
      <div>
        ...
        >
          <Image
            src="https://i.ibb.co/YLNtT2R/images.jpg"
            alt="hero"
            width={1920}
            height={600}
          />
